                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="paciente_lista.php"> <i class="fa fa-list"></i> Lista de Campañas </a>
                                </div>
                            </div>
                            <div class="panel-body">
                                <!-- Form Registrar Campaña -->
                                <span>Formulario para Registrar Nuevo</span>
                            </div>
                        </div>
                    </div>
                </div>
