                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="success">
                                                ...
                                                <tr>
                                                    <td><input type="date" name="BCG" id="BCG" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="HBO" id="HBO" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Rotavirus1" id="Rotavirus1" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Rotavirus2" id="Rotavirus2" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                <tr>
                                                    <th>Penta 1</th>
                                                    <th>Penta 2</th>
                                                    <th>Penta 3</th>
                                                ...
                                                <tr>
                                                    <td><input type="date" name="Penta1" id="Penta1" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Penta2" id="Penta2" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Penta3" id="Penta3" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Poliomielitis1" id="Poliomielitis1" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><input type="date" name="Poliomielitis2" id="Poliomielitis2" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Poliomielitis3" id="Poliomielitis3" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Neumococo1" id="Neumococo1" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Neumococo2" id="Neumococo2" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                </tr>
                                                <tr>
                                                    <th>Neumococo 3</th>
                                                    <th>SR</th>
                                                ...
                                                <tr>
                                                    <td><input type="date" name="Neumococo3" id="Neumococo3" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="SR" id="SR" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="SRP" id="Penta1" class="SRP" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Varicela" id="Varicela" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                </tr>
                                                <tr>
                                                    <th>FA</th>
                                                    <th>OPV</th>
                                                ...
                                                <tr>
                                                    <td><input type="date" name="FA" id="FA" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="OPV" id="OPV" class="SRP" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                    <td><input type="date" name="Influenza" id="Influenza" class="form-control" placeholder="Ingrese Fecha de Fin" value=""></td>
                                                </tr>
                                            </thead>
                                            <tbody>
