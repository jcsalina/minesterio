...
if(!isset($_GET['id'])) {
    ...
    if (isset($_POST['registrar_form'])) {
        ...
        $stockinsumo_actualizar = $pdo->prepare("INSERT INTO stockinsumo (id_insumo, cantidad, lote, fecha_ingreso, fecha_expiracion)
                                                 VALUES (:id_insumo, :cantidad, :lote, :fecha_ingreso, :fecha_expiracion)");
