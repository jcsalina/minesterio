                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="insumos_lista.php"> <i class="fa fa-list"></i> Lista de Insumos </a>
                                </div>
                            </div>
                            <div class="panel-body">
                                <!-- Form Registrar Insumo -->
                                <?php require_once "../../pdo/php/connect.php";?>
                                <?php include '../../app/stock/insumos_registrar_form.php';?>
                            </div>
                        </div>
                    </div>
                </div>
