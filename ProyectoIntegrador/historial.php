        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="header-title">
                    ...
                    <h1>Historial</h1>
                    <small>Historial del Paciente</small>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-4 form-group">
                                        <label>Cédula</label>
                                        <input type="number" name="cedula_paciente" id="cedula_paciente" class="form-control" placeholder="Ingrese Cédula Paciente" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4 form-group">
                                        <label>Pertenece</label>
                                        <input type="text" name="pertenece" id="pertenece" class="form-control" placeholder="Paciente Padre" value="">
                                    </div>
                                </div>
