                ...
                <div class="panel-heading">
                    <div class="view-header">
                        ...
                        <div class="header-title">
                            ...
                            <small><strong>Ingrese sus credenciales para iniciar sesión.</strong></small>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                        ...
                        <div class="form-group add-on">
                            ...
                            <a href="recuperar_clave.php" style="font-size: 13px; text-align: right;">¿Olvido su contraseña?</a>
                        </div>
                        <div>
                    ...
                    <?php 
                        if(isset($_POST['cedula_persona']) && isset($_POST['clave'])) {
                            ...
                            require_once "pdo/procesos/login.php";
